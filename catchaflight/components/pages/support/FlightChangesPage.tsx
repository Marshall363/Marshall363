...
const steps = [
  {
    ...
    body: "Share the details of the change you need — new dates, routes, passenger info, or seat preferences.",
  },
  {
    number: "02",
    icon: Search,
    title: "We Review Your Options",
    body: "Our specialists check airline policies, fare differences, and available alternatives to find the best path forward.",
  },
  {
    number: "03",
    icon: FileCheck,
    title: "Confirm Your Changes",
    body: "Review the updated itinerary, understand any fare adjustments, and approve the modifications.",
  },
  {
    number: "04",
    icon: Send,
    title: "Receive Updated Itinerary",
    body: "Get your confirmed new booking details with all changes reflected and ready to go.",
  },
];
...
export default function FlightChangesPage() {
  return (
    <>
      <Header />
      <main>
        ...
        <PageHero
          ...
          title="Flight Changes Made Simple"
          subtitle="Need to modify your itinerary? Our specialists navigate airline policies so you don't have to."
        />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              ...
              <motion.div {...fadeUp}>
                ...
                <p className="text-lg text-text-secondary mt-6 leading-relaxed">
                  Flight changes don&apos;t have to be complicated. Whether you
                  need to adjust dates, change routes, or modify passenger
                  details, our experienced specialists handle the entire process.
                </p>
              </motion.div>
        ...
        <section className="bg-surface py-[60px] md:py-[100px]">
          <div className="max-w-[1200px] mx-auto px-6">
            <motion.div {...fadeUp} className="text-center">
              ...
              <h2 className="text-[32px] md:text-[40px] font-bold leading-tight text-text-primary">
                How We Help With Flight Changes
              </h2>
            </motion.div>
