...
const steps = [
  {
    ...
    body: "Provide your booking reference and flight details so we can pull up your reservation and review your options.",
  },
  {
    number: "02",
    icon: MessageSquare,
    title: "We Explain Your Options",
    body: "Our specialists walk you through the airline's cancellation policy, refund eligibility, and alternative solutions.",
  },
  {
    number: "03",
    icon: FileX2,
    title: "Process the Cancellation",
    body: "Once you decide, we handle the cancellation process with the airline on your behalf, ensuring everything is done correctly.",
  },
  {
    number: "04",
    icon: Wallet,
    title: "Secure Your Refund",
    body: "We follow up to ensure your refund, travel credit, or voucher is processed and delivered to you.",
  },
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <PageHero
          label="CANCELLATIONS"
          title="Cancellation Support & Guidance"
          subtitle="We help you navigate airline cancellation policies and understand your refund options."
        />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              <motion.div {...fadeUp}>
                ...
                <p className="text-lg text-text-secondary mt-6 leading-relaxed">
                  Cancelling a flight can be confusing with varying airline
                  policies. Our specialists help you understand your options,
                  process cancellations correctly, and pursue the best possible
                  refund.
                </p>
              </motion.div>
        ...
        <section className="bg-surface py-[60px] md:py-[100px]">
          <div className="max-w-[1200px] mx-auto px-6">
            <motion.div {...fadeUp} className="text-center">
              ...
              <h2 className="text-[32px] md:text-[40px] font-bold leading-tight text-text-primary">
                How We Help With Cancellations
              </h2>
            </motion.div>
